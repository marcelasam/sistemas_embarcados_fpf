// Atividade: Controle de LED por número na serial (switch case)
// Exemplo de uso do comando switch para tomar decisões com base em números recebidos pela serial.
// Se receber 0, desliga o LED; se receber 1, liga o LED; outros valores não fazem nada.
